                ...
                <div class="border-b border-gray-200 shadow">
                    <table>
                        ...
                        <tbody class="bg-white">
                            @forelse($Willing_To_Escort as $WillingToEscort)
                                <tr class="whitespace-nowrap">
                                    <td class="px-6 py-4">
                                        <div class="text-sm text-gray-900">
                                            {{$WillingToEscort->willing_to_escort}}
                                        </div>
                                    </td>
                                    <td class="px-6 py-4">
                                        <form class="pt-3" action="{{route('WillingToEscort.destroy', ['WillingToEscort' => $WillingToEscort->id])}}" method="post">
                                            @csrf
                                            @method('DELETE')

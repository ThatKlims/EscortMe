...
<div class="flex h-screen">
    <div class="px-4 py-2 bg-gray-200 bg-indigo-600 lg:w-1/4">
        ...
        <div class="hidden lg:block">
            <div class="my-2 mb-6">
                <h1 class="text-2xl font-bold text-white">{{Auth::user()->name }}'s Dashboard</h1>
            </div>
            <ul>
                <li class="mb-6">
                ...
                <li class="mb-2 rounded hover:shadow hover:bg-gray-800">
                    <a href="{{route('Posts.create')}}" class="inline-block w-full h-full px-3 py-2 font-bold text-white">
                        <span class="inline-flex items-center justify-center h-12 w-12 text-lg text-gray-400"><i class="bx bx-plus"></i></span>
                        <span class="text-sm font-medium">Create A Post (can't have more than one)</span>
                    </a>
                </li>
